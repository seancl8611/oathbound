...
The game should feel disciplined, dangerous, elegant, and cursed. Martial clarity comes first; atmosphere supports it. Even ornate enemies, environments, and effects must remain readable during moment-to-moment combat.
...
- Sekiro-style posture, parry, and deathblow readability
- Hades-style run structure, reward routing, arena pressure, and hub return
