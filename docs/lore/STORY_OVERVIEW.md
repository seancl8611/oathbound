...
Akio is the only known bearer with genuine control over Beast Blood. Other bearers may retain intelligence, humanity, skill, or deliberate mutation use, but they remain unable to reject the Blood's rule. Akio can Resist, consciously Embrace, express different Aspects, return toward a controlled baseline, and continue opposing the Heart itself.
...
- A quiet warrior using forbidden power without accepting its rule
