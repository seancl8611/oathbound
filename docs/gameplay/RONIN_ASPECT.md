...
Exact numerical values, frame data, hitboxes, animation timing, VFX density, Blood values, proc weighting, and final recovery windows remain implementation and playtesting work unless a first-playtest baseline is explicitly locked below or in `ASPECT_IMPLEMENTATION_BASELINES.md`.
...
- the highest or near-highest per-hit enemy-posture pressure where authored enemy rules still use it,
...
- and the strongest ordinary guard profile through reduced blocked-Health chip.
...
1. **Severing Cut** — the most reliable Basic for short openings; compact line, meaningful Health damage, and meaningful pressure.
2. **Crushing Cross** — broader frontal coverage, greater commitment, and Ronin's clearest ordinary group-control Basic.
3. **Bloodfall** — the most committed Basic, with the sequence's largest damage, pressure, and stagger payoff and severe miss recovery.
...
- major single-hit Health and pressure damage,
...
It has conventional reach and lower damage, pressure, and stagger than the main heavy sequence. Its purpose is responsiveness, not pursuit dominance or maximum punishment.

### Parry Counter — Answering Steel

A forceful retaliatory strike after the universal authored parry.

It provides Ronin's strongest immediate parry conversion through high Health damage, high enemy pressure, and strong ordinary-enemy recoil or stagger, while remaining planted enough to be unsafe against surrounding threats.

### Defensive profile

Player-facing Posture is retired. Ordinary Guard is Health-first: a valid frontal block passes a fraction of incoming damage to Health instead of filling a separate break meter.

The shared Tier 0 guard baseline passes **35%** of incoming blockable Health damage. Ronin begins stronger at **30%**.

This is balanced by:

- every block still costing real Health,
- heavy attacks that delay access to defense,
- no passive defensive resource that can be regenerated between blocks,
- no Tier 0 interruption resistance or general damage reduction,
- and full damage when an attack bypasses the authored guard arc or is otherwise unblockable.

Ronin can absorb direct pressure more efficiently than the other launch Aspects, but holding Guard is not free and cannot create an infinite defensive state.

## Tier-growth rule — guard Health efficiency

Beginning at Tier I, **every Embrace modestly improves Ronin's blocked-Health conversion**. The first-playtest rule reduces the fraction of incoming Health damage by 2.5 percentage points at each Tier:
...
- never makes ordinary Guard free,
- does not heal Health,
- does not grant interruption immunity,
- does not change parry timing or defensive inputs,
- and does not protect attacks outside the authored frontal guard arc.

# Fixed Tier progression

## Tier I — Steadfast Reprisal

After successfully blocking a blockable enemy attack, Akio briefly gains the option to perform **Reprisal Cut** with the Basic Attack input.

### Reprisal Cut

- slow, planted, compact frontal heavy retaliation,
- available only after the relevant block recovery,
- strong Health damage, substantial enemy pressure, and powerful ordinary-enemy stagger,
...
The retaliation is optional and temporary. Blocking does not accelerate its startup, move Akio into range, protect the counter, restore Health, or correct aim.

**Tier I also applies the first guard-efficiency growth step.**

## Tier II — Falling Mountain

Tier II unlocks Ronin's Blood meter and **Falling Mountain**.

Ronin builds Blood through meaningful heavy Health damage and valid Aspect-owned combat conversions. Exact weighting remains tuning work and must not depend on the retired player Posture resource.

Falling Mountain no longer clears or restores a defensive resource on activation. Committing the Blood Art spends the earned Blood and the payoff remains its offensive impact, delayed rupture, and authored commitment rules.
...
During the brief channel, eligible ordinary hits do not interrupt the action, but they still deal full Health damage, status buildup, and other valid effects. Lethal damage, perilous or unblockable attacks, grabs, launches, and overriding knockdowns interrupt normally.
...
- deals strong Health damage and strong authored enemy pressure,
...
**Tier II also applies the second guard-efficiency growth step.**
...
The incoming hit still applies full Health damage, status, and other valid effects. Resolve fails against lethal damage, perilous or unblockable attacks, grabs, launches, overriding knockdowns, non-frontal pressure, or a second hit.
...
- increased authored enemy pressure,
...
**Tier III also applies the third guard-efficiency growth step.**
...
Shattering Wake deals reduced Health damage, strong authored enemy pressure, strong guard recoil, and forceful eligible ordinary-enemy stagger to enemies behind the primary target.
...
A Perfect Weight originating strike strengthens the Wake's pressure, guard-recoil, and eligible stagger payoff without adding a major Health-damage increase.

**Tier IV also applies the fourth and final guard-efficiency growth step.**

# Progression summary

| Tier | Headline benefit | Supporting growth |
|---|---|---|
| Tier 0 | Complete heavy-impact weapon kit and strongest baseline guard | 30% blocked-Health conversion |
| Tier I | Steadfast Reprisal / Reprisal Cut | 27.5% blocked-Health conversion |
| Tier II | Falling Mountain / Deep Rupture | 25% blocked-Health conversion |
| Tier III | Unbroken Resolve / Measured Weight / Perfect Weight | 22.5% blocked-Health conversion |
| Tier IV | Shattering Wake | 20% blocked-Health conversion |

The progression fantasy is:

> absorb direct pressure efficiently → answer deliberately → spend Blood on one monumental point impact → master costly versus clean commitments → drive heavy force through enemy formations

## Technique space

Techniques may reinforce or compensate for Ronin's heavy Basics, Stillness Draw, direct damage, pressure chunks, stagger, attack speed, pursuit, recovery, fixed lines, mobile enemies, surrounding pressure, blocking, parrying, or Prosthetics.
...
- exact attack damage, pressure, stagger, block pressure, and Health values where not already established as first-playtest baselines,
- exact startup, active, recovery, and Resolve windows,
- final guard Health-conversion tuning if playtesting proves the 30% → 20% Ronin curve too weak or too dominant,
