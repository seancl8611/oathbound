...
The region represents false ascendancy. Its inhabitants believe strength, ritual, hierarchy, and refinement allowed them to master Beast Blood. In reality, they remain unable to reject its rule.

Kagutsuchi Court remains the established immaculate royal-court setting. It is not replaced by an underground city, Eclipse Palace, living citadel, or another discarded region concept.
...
- gilded trim,
- clean stone,
- shallow mirror-still water,
- silk banners,
- paper lanterns,
- refined roof tile,
- immaculate blossom-covered courtyards.

Corruption appears through impossible maintenance, elegant specialized mutation, and refusal to allow visible decline rather than through ordinary ruin.

## Enemy-family identity

Court enemies are elite soldiers, retainers, ritualists, vessels, and guardians who retain loyalty to the Shogun and recognition of the Court.

They may direct Beast Blood abilities, conceal mutations, perform rituals, and choose when to reveal greater power. None of these traits equal genuine control.

Movement is precise, elegant, and unnaturally controlled. Wrongness comes from intelligence and restraint serving the curse.
...
- precise elite melee pressure,
- ritual projectiles and controlled zones,
- revival and kill-confirmation windows,
- directional shield denial,
- spawning and source-priority pressure,
- heavy bruiser frenzy,
- multi-cycle objective combat,
- disciplined duel combat,
- Shogun martial and Beast Blood escalation,
- post-Shogun Binding completion,
- two-form large-creature Heart continuation.
