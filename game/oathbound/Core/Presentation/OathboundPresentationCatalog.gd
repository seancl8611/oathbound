...
static func achievements() -> Array[Dictionary]:
	return [
		...
		{"id":"relics_all","name":"What the Island Left","loc_key":"achievement.relics_all","description":"Collect all 10 Relics.","trigger":"relics_10"},
		...
		{"id":"relic_mastery_all","name":"Ten Histories, Mastered","loc_key":"achievement.relic_mastery_all","description":"Complete all 20 Relic mastery milestones.","trigger":"relic_masteries_20"},
...
static func help_topics() -> Array[Dictionary]:
	return [
		...
		{"id":"techniques","title":"Techniques","loc_key":"help.techniques","body":"Techniques modify attacks, defense, movement, Prosthetic use, and build interactions. Direct Techniques occupy the run's direct action slots while supporting, cross-family, and legendary effects can remain slotless according to their category."},
