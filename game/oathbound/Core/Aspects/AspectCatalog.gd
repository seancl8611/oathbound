...
static func _base_basic_profiles() -> Array:
	return [
		# Manual telemetry from the 2026-09-13 Area 1 playtest showed ordinary clean
		# Health hits filling Posture faster than the intended HP-removal cadence (a fresh
		# Hollow took 36/40 Posture from one Heavy). Keep block-Posture authored high so
		# guard remains a tactical Posture route, but normal unguarded hits now primarily
		# advance Health unless parries/other Posture pressure have already contributed.
		_base_profile({"id":"quick_slash","display_name":"Quick Slash","action_trigger":"basic","anim":"attack","anim_speed":1.08,"duration":0.36,"startup":0.055,"active":0.075,"recovery":0.19,"queue_start":0.36,"combo_start":0.46,"combo_end":0.94,"cancel_at":0.80,"lunge_start":0.055,"lunge_speed":34.0,"lunge_time":0.035,"health_damage":9,"damage":9,"posture_damage":6.0,"posture":6.0,"block_posture_damage":10.0,"stagger_level":0,"proc_coefficient":1.0,"knockback":105.0,"hitstop":0.060,"hitbox_offset":19.0,"hitbox_shape":"slash_small","hitbox_scale":Vector2(0.90,0.90),"shake":2.0,"can_combo":true}),
		_base_profile({"id":"cross_cut","display_name":"Cross Cut","action_trigger":"basic","anim":"attack_2","anim_speed":0.90,"duration":0.46,"startup":0.085,"active":0.105,"recovery":0.24,"queue_start":0.40,"combo_start":0.50,"combo_end":0.92,"cancel_at":0.84,"lunge_start":0.085,"lunge_speed":46.0,"lunge_time":0.055,"health_damage":12,"damage":12,"posture_damage":9.0,"posture":9.0,"block_posture_damage":16.0,"stagger_level":0,"proc_coefficient":1.0,"knockback":145.0,"hitstop":0.095,"hitbox_offset":23.0,"hitbox_shape":"slash_wide","hitbox_scale":Vector2(1.25,1.08),"shake":4.0,"can_combo":true}),
		_base_profile({"id":"heavy_cleave","display_name":"Heavy Cleave","action_trigger":"basic","anim":"attack_3","anim_speed":0.70,"duration":0.68,"startup":0.180,"active":0.135,"recovery":0.37,"queue_start":1.00,"combo_start":1.00,"combo_end":1.00,"cancel_at":0.94,"lunge_start":0.180,"lunge_speed":24.0,"lunge_time":0.085,"health_damage":21,"damage":21,"posture_damage":18.0,"posture":18.0,"block_posture_damage":36.0,"stagger_level":1,"proc_coefficient":1.0,"knockback":230.0,"hitstop":0.170,"hitbox_offset":28.0,"hitbox_shape":"cleave_heavy","hitbox_scale":Vector2(1.55,1.25),"shake":8.0,"can_combo":false}),
	]
